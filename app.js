...
console.log("Ovo su deca ",listaDestinacija2.children);
let listaDestinacija3=document.querySelector("#lista-destinacija");
console.log("Next siblings: ",listaDestinacija3.nextElementSibling);
console.log("Previous siblings: ",listaDestinacija3.previousElementSibling);

let banner= document.querySelector("#page-banner");
console.log("baner node name is: ", banner.nodeName);
